                ...
                <div class="site-navigation">
                    <div class="row g-0 align-items-center">
                        ...
                        <div class="col-8 text-center">
                            <form action="{{ url('blog') }}" method="GET" class="search-form d-inline-block d-lg-none">
                                <input type="text" class="form-control" placeholder="Search..." name="search" value="{{ isset($q) ? $q : null }}"/>
                            ...
                            <ul class="js-clone-nav d-none d-lg-inline-block text-start site-menu mx-auto">
                                ...
                                <li class="{{ request()->is('blog') || request()->is('/blog') ? 'active' : '' }}"><a
                                        href="{{ route('blog') }}">Blog</a></li>
                                <li class="{{ request()->is('about') || request()->is('/about') ? 'active' : '' }}"><a
                                        href="{{ route('about') }}">About</a></li>
                                <li
                                    class="{{ request()->is('contact') || request()->is('/contact') ? 'active' : '' }}">
