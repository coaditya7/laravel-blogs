            ...
            <div class="card-body">
                <form action="{{ route('admin.posts.update', $post->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="excerpt" id="" cols="30" rows="10">{{ old('excerpt', $post->excerpt) }}</textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control" id="banner" placeholder="{{ __('Banner') }}" name="banner" value="{{ old('banner', $post->banner) }}" />
                    </div>
